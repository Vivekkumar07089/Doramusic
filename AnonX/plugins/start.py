...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} ᴊᴜsᴛ sᴛᴀʀᴛᴇᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ᴄʜᴇᴄᴋ ɪɴғᴏ <code>sᴜᴅᴏʟɪsᴛ</code>\n\n**ᴜsᴇʀɪᴅ:-** {sender_id}\n**ɴᴀᴍᴇ:-** {sender_name}",
                )
            return
        if name[0:3] == "lyr":
        ...
        if name == "verify":
            ...
            return
        if name[0:3] == "inf":
            m = await message.reply_text("🥀sᴇᴀʀᴄʜɪɴɢ ғᴏʀ ʏᴏᴜ......")
            ...
            searched_text = f"""
 **♕︎sᴏɴɢ ɪɴғᴏʀᴍᴀᴛɪᴏɴ♕︎**\n\n**ɴᴀᴍᴇ ➪ [{title}]({link})**\n**ᴅᴜʀᴀᴛɪᴏɴ ➪ [{duration} ᴍɪɴ.]({link})\n**ᴠɪᴇᴡs ➪ [{views}]({link})**\n**ᴜᴘʟᴏᴀᴅᴇᴅ ᴏʙ ➪ [{published}]({link})**\n**ᴄʜᴀɴɴᴇʟ ➪ [{channel}]({link})**\n**ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ ➪ [ᴠɪsɪᴛ ᴄʜᴀɴɴᴇʟ]({channellink})**\n**ʟɪɴᴋ ➪ [ᴡᴀᴛᴄʜ ᴏɴ ʏᴏᴜᴛᴜʙᴇ]({link})**\n\n☆.............ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ ............☆"""
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} ᴊᴜsᴛ sᴛᴀʀᴛᴇᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ᴄʜᴇᴄᴋ <code>sᴏɴɢ ɪɴғᴏ</code>\n\n**ᴜsᴇʀ ɪᴅ:-** {sender_id}\n**ɴᴀᴍᴇ:-** {sender_name}",
                )
    else:
        try:
        ...
        if await is_on_off(config.LOG):
            ...
            return await app.send_message(
                config.LOG_GROUP_ID,
                f"{message.from_user.mention} ᴊᴜsᴛ sᴛᴀʀʏᴇᴅ ᴛʜᴇ ʙᴏᴛ.\n\n**ᴜsᴇʀ ɪᴅ:-** {sender_id}\n**ɴᴀᴍᴇ:-** {sender_name}",
            )
...
async def welcome(client, message: Message):
    ...
    if config.PRIVATE_BOT_MODE == str(True):
        if not await is_served_private_chat(message.chat.id):
            await message.reply_text(
                "**ɢʀᴏᴜᴏ ɪs ᴘʀɪᴠᴀᴛᴇ**\n\nᴏɴʟʏ ᴘᴜʙʟɪᴄ ᴄʜᴀᴛ's ᴀʟʟᴏᴡᴇᴅ ᴛᴏ ᴘʟᴀʏ ᴍᴜsɪᴄ , ɪғ ᴅᴏɴ'ᴛ ᴡᴀɴᴛ ᴍᴀᴋᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ/ᴄʜᴀɴɴᴇʟ ᴘᴜʙʟɪᴄ ʀᴇǫᴜᴇsᴛ ᴍʏ ᴏᴡɴᴇʀ ᴛᴏ ᴀᴜᴛʜᴏʀɪᴢᴇ ʏᴏᴜʀ ᴄʜᴀᴛ ᴛᴏ ᴘʟᴀʏ ᴍᴜsɪᴄ ɪɴ ʏᴏᴜʀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ."
            )
